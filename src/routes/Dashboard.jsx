...
const Dashboard = () => {
  ...
  return (
    <div className={`flex h-[100svh] bg-black overflow-x-hidden`}>
      <Sidebar />
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0 sm:pl-64">
                {!(location.pathname.includes('/dashboard/chatbot') || location.pathname.includes('/dashboard/meeting')) && <Topbar />}
