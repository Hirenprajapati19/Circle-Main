    ...
    <div className="p-2 sm:p-6 bg-black min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-8 gap-3 sm:gap-4">
          <div>
            <h1 className="text-lg sm:text-2xl font-bold font-poppins text-red-600 mb-1 sm:mb-2">
              Status Updates
            </h1>
          ...
          <Button
            ...
            className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm bg-red-600 text-white hover:bg-red-700 rounded-full px-3 sm:px-4 py-2 shadow-md"
          >
